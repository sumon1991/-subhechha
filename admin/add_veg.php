...
if (isset($_POST['submit'])) {
    ...
    $sql_cust = "INSERT INTO vegetables_details 
	             SET
				         vegetable_name           = '" . $post['vegetable_name'] . "',   
						 create_date        = '" . date('Y-m-d H:i:s') . "'
				 ";
    mysql_query($sql_cust);
    
    $_SESSION['success'] = "Vegetable addedd successfully.";
...
<div class="right_col" role="main">
    <a href="?page=veg_lists"> Vegetables list</a>&nbsp;&nbsp;Vegetables Add
    <!-- top tiles -->
    <div class="row tile_count">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2> Vegetable Add<small>For Vegetable Add</small></h2>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="vegetable_name" placeholder="Vegetable Name" name="vegetable_name"  class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" required />
                            </div>
                        </div>
