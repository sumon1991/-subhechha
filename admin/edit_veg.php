...
$select_cust = "SELECT * FROM vegetables_details WHERE id = '" . $id . "'";
...
if (isset($_POST['submit'])) {
    ...
    $sql_cust = "UPDATE vegetables_details SET vegetable_name = '" . $post['vegetable_name'] . "'  
	             WHERE id = '" . $id . "'";
    //echo $sql_cust; exit;
    $sql_insert = mysql_query($sql_cust);

    $_SESSION['success'] = "Vegetable has been Updated successfully";
    echo '<script>window.location="' . SITE_URL . '/?page=veg_lists"</script>';
}
...
<div class="right_col" role="main">
    <a href="?page=veg_lists"> Vegetables list</a>&nbsp;&nbsp;Vegetables Edit
    <!-- top tiles -->
    <div class="row tile_count">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2> Vegetable Edit<small>For Vegetable Edit</small></h2>
                ...
                <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Vegetable Name</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="vegetable_name" placeholder="Vegetable Name" name="vegetable_name"  class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" value="<?php echo $select_fetch['vegetable_name']; ?>" required />
                            </div>
                        </div>
