...
$select_cust  = "SELECT * FROM ".EMP_TYPE." WHERE id = '".$id."'";
...
if(isset($_POST['submit']))
{
	...
	$sql_cust = "UPDATE ".EMP_TYPE." 
	 ...
	 if($sql_insert > 0){
		  $_SESSION['success'] = "Employee Category has been Update successfully";
      ...
      <div class="right_col" role="main">
        ...
        <div class="row tile_count">
           ...
           <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2> Employee Category Edit<small>For Employee Category Edit</small></h2>
              ...
              $('#birthday').daterangepicker({
                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                   ...
                   <input type="hidden" id="emp_type_id" placeholder="Customer Name" name="emp_type_id"  class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" value="<?php echo $id;?>" required />
                    <div class="form-group">
                      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Employee Category</label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="type_name" placeholder="Employee Category" name="type_name"  class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" value="<?php echo $select_fetch['type_name'];?>" required />
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Emplpoyee Description</label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
