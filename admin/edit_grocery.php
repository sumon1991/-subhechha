...
$select_cust = "SELECT * FROM grocery_details WHERE id = '" . $id . "'";
...
if (isset($_POST['submit'])) {
    ...
    $sql_cust = "UPDATE grocery_details SET grocery_name = '" . $post['grocery_name'] . "'  
	             WHERE id = '" . $id . "'";
    //echo $sql_cust; exit;
    $sql_insert = mysql_query($sql_cust);

    $_SESSION['success'] = "Grocery item has been Updated successfully";
    echo '<script>window.location="' . SITE_URL . '/?page=grocery_lists"</script>';
}
...
<div class="right_col" role="main">
    <a href="?page=grocery_lists"> Grocery Item list</a>&nbsp;&nbsp;Grocery Item Edit
    <!-- top tiles -->
    <div class="row tile_count">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2> Grocery Item Edit<small>For Grocery Item Edit</small></h2>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="grocery_name" placeholder="Item Name" name="grocery_name"  class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" value="<?php echo $select_fetch['grocery_name']; ?>" required />
                            </div>
                        </div>
