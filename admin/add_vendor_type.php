...
if(isset($_POST['submit']))
{
	...
	$selec_typ   = "SELECT * FROM ".VEND_TYPE." WHERE vender_type = '".$vender_type."'";
	$selec_query =  mysql_query($selec_typ);
	$selec_rows = mysql_num_rows($selec_query);
	if($selec_rows > 0){
		$_SESSION['error'] = "Vendor Type has been Already Added...";
        echo '<script>window.location="'.SITE_URL.'/?page=add_vendor_type"</script>';
		}
	else{
	$sql_type = "INSERT INTO ".VEND_TYPE." 
	             SET
	...
	if($sql_insert > 0){
		...
		$_SESSION['success'] = "Vendor Type has been Added successfully";
       ...
       Vendor Type Add
        ...
        <div class="row tile_count">
           ...
           <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Vendor Type Add<small>For Vendor Type Add</small></h2>
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="vender_type" placeholder="Vendor Type" name="vender_type"  class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" required />
                      </div>
                    </div>
