...
if (isset($_POST['submit'])) {
    ...
    $sql_cust = "INSERT INTO bank_details 
	             SET
				         bank_name           = '" . $post['bank_name'] . "',  
						 branch_name        = '" . $post['branch_name'] . "',
                                                 acc_no             = '" . $post['acc_no'] . "',   
						 ifsc_code          = '" . $post['ifsc_code'] . "',
                                                 last_updated_balance = '" . $post['last_updated_balance'] . "',   
						 create_date        = '" . date('Y-m-d H:i:s') . "'
				 ";
    mysql_query($sql_cust);
    $sql_insert = mysql_insert_id();

    $sqlInsert = "INSERT INTO bank_transfer_history SET
                 bank_id = '" . $sql_insert . "',
                 transfer_type = '2',
                 amount = '" . $post['last_updated_balance'] . "',
                 transact_with = '3',
                 date = '" . date('Y-m-d H:i:s') . "',
                 transcation_date  = '" . date('Y-m-d') . "',
                 purpose = 'Opening Balance'    
                ";
    mysql_query($sqlInsert);

    $_SESSION['success'] = "Bank addedd successfully.";
...
<div class="right_col" role="main">
    <a href="?page=bank_lists"> Bank list</a>&nbsp;&nbsp;Bank Add
    <!-- top tiles -->
    <div class="row tile_count">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2> Bank Add<small>For Bank Add</small></h2>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="bank_name" placeholder="Bank Name" name="bank_name"  class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" required />
                            </div>
                        </div>
