               ...
               <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="purpose" placeholder="Purpose" value="<?php echo $cust_fetch['purpose'];?>" name="purpose" class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" required />
                     </div>
                  </div>
                  <div class="form-group">
                     <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Date</label>
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="birthday" placeholder="Date" value="<?php echo $cust_fetch['date'];?>" name="date" class="date-picker form-control col-md-7 col-xs-12 active" required />
                     </div>
                  </div>
                  <div class="form-group">
                     <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Time</label>
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="customer_phone" value="<?php echo $cust_fetch['time'];?>" placeholder="Time" name="time" class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" required />
                     </div>
                  </div>
                  <div class="form-group">
                     <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Location</label>
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="customer_phone"  value="<?php echo $cust_fetch['location_address'];?>" placeholder="Location" name="location_address" class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" required />
                     </div>
                  </div>
                  <div class="form-group">
                     <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Person Invitation</label>
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="customer_phone" value="<?php echo $cust_fetch['invitaion_person'];?>" placeholder="Person Invitation" name="invitaion_person" class="form-control col-md-7 col-xs-12 col-md-7 col-xs-12" required />
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_1" value="<?php echo $cust_ite_fetch['item_1'];?>" class="form-control col-md-7 col-xs-12" required="required">
                     </div>
                     <label class="control-label col-md-2 col-sm-2 col-xs-6" for="first-name">Item 2 <span class="required"></span>
                     </label>
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_2" value="<?php echo $cust_ite_fetch['item_2'];?>" class="form-control col-md-7 col-xs-12" required="required">
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_3" value="<?php echo $cust_ite_fetch['item_3'];?>" class="form-control col-md-7 col-xs-12" required="required">
                     </div>
                     <label class="control-label col-md-2 col-sm-2 col-xs-6" for="first-name">Item 4 <span class="required"></span>
                     </label>
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_4" value="<?php echo $cust_ite_fetch['item_4'];?>" class="form-control col-md-7 col-xs-12" required="required">
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_5" value="<?php echo $cust_ite_fetch['item_5'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                     <label class="control-label col-md-2 col-sm-2 col-xs-6" for="first-name">Item 6 <span class="required"></span>
                     </label>
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_6" value="<?php echo $cust_ite_fetch['item_6'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_7" value="<?php echo $cust_ite_fetch['item_7'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                     <label class="control-label col-md-2 col-sm-2 col-xs-6" for="first-name">Item 8 <span class="required"></span>
                     </label>
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_8" value="<?php echo $cust_ite_fetch['item_8'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_9" value="<?php echo $cust_ite_fetch['item_9'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                     <label class="control-label col-md-2 col-sm-2 col-xs-6" for="first-name">Item 10 <span class="required"></span>
                     </label>
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_10" value="<?php echo $cust_ite_fetch['item_10'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_11" value="<?php echo $cust_ite_fetch['item_11'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                     <label class="control-label col-md-2 col-sm-2 col-xs-6" for="first-name">Item 12 <span class="required"></span>
                     </label>
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_12" value="<?php echo $cust_ite_fetch['item_12'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_13" value="<?php echo $cust_ite_fetch['item_13'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                     <label class="control-label col-md-2 col-sm-2 col-xs-6" for="first-name">Item 14 <span class="required"></span>
                     </label>
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_14" value="<?php echo $cust_ite_fetch['item_14'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_15" value="<?php echo $cust_ite_fetch['item_15'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                     <label class="control-label col-md-2 col-sm-2 col-xs-6" for="first-name">Item 16 <span class="required"></span>
                     </label>
                     <div class="col-md-4 col-sm-4 col-xs-6">
                        <input type="text" name="item_16" value="<?php echo $cust_ite_fetch['item_16'];?>" class="form-control col-md-7 col-xs-12">
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea name="extra" required="required" parsley-minwords="3" placeholder=""  class="form-control col-md-7 col-xs-12" rows="5"><?php echo $cust_ite_fetch['extra'];?></textarea>      
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="number" class="form-control" name="total_payable_money" value=<?php echo $cust_ite_fetch['total_payable_money'];?>>      
                     </div>
                  </div>
                  <!-- <div class="form-group">
